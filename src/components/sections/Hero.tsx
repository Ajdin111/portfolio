export default function Hero() {
  return (
    <section
      id="hero"
      className="min-h-screen flex flex-col justify-center px-8 md:px-16 lg:px-20 py-20 relative overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-3xl">
        <p className="text-teal-400 text-xs font-mono uppercase tracking-widest mb-6">
          Sarajevo, Bosnia
        </p>

        <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold text-white leading-tight tracking-tight mb-6">
          Ajdin<br />Mujkanović
        </h1>
