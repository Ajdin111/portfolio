    ...
    >
      <div className="max-w-3xl mx-auto w-full">
        ...
        <p className="text-gray-500 text-base mb-10 max-w-md">
          Feel free to reach out if you'd like to discuss a project, collaboration, or just connect.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
          ...
          >
            <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" className="text-teal-400">
        ...
        {/* Footer */}
        <div className="border-t border-white/5 mt-20 pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <p className="text-gray-600 text-sm">
            © 2026 Ajdin Mujkanović
            <span className="block text-xs mt-1">Sarajevo, Bosnia</span>
          </p>
          <div className="flex items-center gap-4">
            <p className="text-gray-600 text-xs">Built with React & Tailwind CSS</p>
            <button
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              className="text-gray-600 hover:text-teal-400 transition-colors duration-200 text-xs flex items-center gap-1"
            >
              Back to top
